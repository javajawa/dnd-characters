...
export class NumericValue implements Value{
  readonly value: number
  readonly reason: string

  constructor(val: number, reason: string) {
    this.value = val;
    this.reason = reason;
  }
...
export class MultiplierValue implements Value {
  private readonly multiplier: number
  private readonly target: Value
  readonly reason: string

  constructor(mul: number, val: number | Value, reason: string) {
